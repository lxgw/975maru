...
2026 年，该字体汉字部分重制，以 [昭源环方](https://github.com/chiron-fonts/chiron-go-round-tc) 为主，[文渊圆体](https://github.com/takushun-wu/WenYuanFonts) 为辅。
...
- 已知问题：
  ...
  - 由于是两个不同标准写法字体的混合字体，因此会存在同一部件形态不统一的情况（如「釒」部件）
